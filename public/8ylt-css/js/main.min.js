...
"use strict";document.addEventListener("DOMContentLoaded",(function(){var e=document.querySelectorAll(".js-dropdown-link"),t=document.querySelectorAll(".js-dropdown");function n(n){var a=this,s=document.getElementById(this.hash.substr(1)),o=this.classList.contains("active");e.forEach((function(e){e.classList.remove("active"),e.setAttribute("aria-expanded","false")})),t.forEach((function(e){return e.classList.remove("open")})),o||(e.forEach((function(e){e.getAttribute("href")===a.hash&&(e.classList.add("active"),e.setAttribute("aria-expanded","true"))})),s.classList.add("open")),n.preventDefault()}function a(n){Array.from(e).concat(Array.from(t)).some((function(e){return e.contains(n.target)}))&&27!==n.keyCode||(e.forEach((function(e){e.classList.remove("active"),e.setAttribute("aria-expanded","false")})),t.forEach((function(e){return e.classList.remove("open")})))}if(e.forEach((function(e){return e.addEventListener("click",n)})),document.addEventListener("mouseup",a),document.addEventListener("touchstart",a),document.addEventListener("keyup",a),$.fn.datepicker){var s,o=new URLSearchParams(window.location.search).get("date");if(o){var i=o.split("-"),r=parseInt(i[0]),c=parseInt(i[1])-1,d=parseInt(i[2]);s=new Date(r,c,d),console.log("Selected Date:",s)}else console.log("Date parameter not found in the URL."),s=new Date;$(".js-calendar").datepicker({defaultDate:s,onSelect:function(e){console.log("Date selected: "+e);var t=baseUrlDay+encodeURIComponent(e);window.location.href=t}})}$.fn.select2&&($(".js-select").select2({minimumResultsForSearch:1/0}),$(".js-select-search").select2({}));new Swiper(".js-days-slider",{loop:!1,rewind:!0,slidesPerView:7,spaceBetween:0,centeredSlides:!0,navigation:{prevEl:".js-days-slider-button-prev",nextEl:".js-days-slider-button-next"},on:{init:function(){var e=this.el.querySelector(".swiper-slide.active"),t=this.slides.findIndex((function(t){return t===e}));this.slideTo(t,0,!1)}}});var l=".js-modal",u=".js-modal-wrap",m=".js-modal-link";if(document.querySelectorAll(m).length){document.body.insertAdjacentHTML("beforeend",'\n      <div class="modal js-modal" role="dialog" aria-labelledby="js-modal-title" aria-modal="true" tabindex="-1" id="modal">\n        <div class="modal__bg js-modal-close">\n          <div class="modal__hold">\n            <div class="js-modal-wrap"></div>\n          </div>\n          <span tabindex="0" aria-hidden="true" onfocus="document.getElementById(\'modal\').focus()"></span>\n        </div>\n      </div>\n    '),$(m).bind("click",(function(e){e.preventDefault();var t=window.innerWidth-document.documentElement.clientWidth;fetch($(this).attr("href")).then((function(e){return e.text()})).then((function(e){var n=document.querySelector(l),a=n.querySelector(u);n.classList.add("open"),a.innerHTML=e,n.addEventListener("transitionend",(function(){n.focus()}),{once:!0}),document.body.classList.add("no-scroll"),document.body.style.paddingRight="".concat(t,"px")})).catch((function(){alert("Fail!")}))}));var f=function(){var e=document.querySelector(l),t=e.querySelector(u);e.classList.remove("open"),e.addEventListener("transitionend",(function(){t.innerHTML="",document.body.classList.remove("no-scroll"),document.body.style.paddingRight="0"}),{once:!0})};document.addEventListener("click",(function(e){e.target.classList.contains("js-modal-close")&&(f(),e.preventDefault())})),document.addEventListener("keyup",(function(e){27===e.keyCode&&f()}))}document.querySelectorAll(".js-button-single").forEach((function(e){e.addEventListener("click",(function(e){e.target.classList.contains("active")?e.target.classList.remove("active"):e.target.classList.add("active"),e.preventDefault()}))})),document.addEventListener("click",(function(e){if("js-btn-pass"===e.target.id){var t=document.querySelector(".js-input-pass");"password"===t.type?t.type="text":t.type="password",e.preventDefault()}})),$("#is_worker").change((function(e){1==$(this).is(":checked")?$(".perms-worker").show():$(".perms-worker").hide()})),$("#is_manager").change((function(e){1==$(this).is(":checked")?$(".perms-manager").show():$(".perms-manager").hide()}))}));
