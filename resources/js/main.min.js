...
"use strict";document.addEventListener("DOMContentLoaded",(function(){var e=document.querySelectorAll(".js-dropdown-link"),t=document.querySelectorAll(".js-dropdown");function n(n){var s=this,a=document.getElementById(this.hash.substr(1)),i=this.classList.contains("active");e.forEach((function(e){e.classList.remove("active"),e.setAttribute("aria-expanded","false")})),t.forEach((function(e){return e.classList.remove("open")})),i||(e.forEach((function(e){e.getAttribute("href")===s.hash&&(e.classList.add("active"),e.setAttribute("aria-expanded","true"))})),a.classList.add("open")),n.preventDefault()}function s(n){Array.from(e).concat(Array.from(t)).some((function(e){return e.contains(n.target)}))&&27!==n.keyCode||(e.forEach((function(e){e.classList.remove("active"),e.setAttribute("aria-expanded","false")})),t.forEach((function(e){return e.classList.remove("open")})))}e.forEach((function(e){return e.addEventListener("click",n)})),document.addEventListener("mouseup",s),document.addEventListener("touchstart",s),document.addEventListener("keyup",s),$.fn.datepicker&&$(".js-calendar").datepicker(),$.fn.select2&&$(".js-select").select2({minimumResultsForSearch:1/0});new Swiper(".js-days-slider",{loop:!1,rewind:!0,slidesPerView:7,spaceBetween:0,centeredSlides:!0,navigation:{prevEl:".js-days-slider-button-prev",nextEl:".js-days-slider-button-next"},on:{init:function(){var e=this.el.querySelector(".swiper-slide.active"),t=this.slides.findIndex((function(t){return t===e}));this.slideTo(t,0,!1)}}});var a=".js-modal",i=".js-modal-wrap",o=".js-modal-link";if(document.querySelectorAll(o).length){document.body.insertAdjacentHTML("beforeend",'\n      <div class="modal js-modal" role="dialog" aria-labelledby="js-modal-title" aria-modal="true" tabindex="-1" id="modal">\n        <div class="modal__bg js-modal-close">\n          <div class="modal__hold">\n            <div class="js-modal-wrap"></div>\n          </div>\n          <span tabindex="0" aria-hidden="true" onfocus="document.getElementById(\'modal\').focus()"></span>\n        </div>\n      </div>\n    '),document.addEventListener("click",(function(e){if(e.target.matches(o)){var t=window.innerWidth-document.documentElement.clientWidth;fetch(e.target.href).then((function(e){return e.text()})).then((function(e){var n=document.querySelector(a),s=n.querySelector(i);n.classList.add("open"),s.innerHTML=e,n.addEventListener("transitionend",(function(){n.focus()}),{once:!0}),document.body.classList.add("no-scroll"),document.body.style.paddingRight="".concat(t,"px")})).catch((function(){alert("Fail!")})),e.preventDefault()}}));var d=function(){var e=document.querySelector(a),t=e.querySelector(i);e.classList.remove("open"),e.addEventListener("transitionend",(function(){t.innerHTML="",document.body.classList.remove("no-scroll"),document.body.style.paddingRight="0"}),{once:!0})};document.addEventListener("click",(function(e){e.target.classList.contains("js-modal-close")&&(d(),e.preventDefault())})),document.addEventListener("keyup",(function(e){27===e.keyCode&&d()}))}document.querySelectorAll(".js-button-single").forEach((function(e){e.addEventListener("click",(function(e){e.target.classList.contains("active")?e.target.classList.remove("active"):e.target.classList.add("active"),e.preventDefault()}))})),document.addEventListener("click",(function(e){if("js-btn-pass"===e.target.id){var t=document.querySelector(".js-input-pass");"password"===t.type?t.type="text":t.type="password",e.preventDefault()}}))}));
